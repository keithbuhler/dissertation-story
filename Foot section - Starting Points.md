...
It is no secret in philosophy that to prove one's thesis one must begin by assuming, on the first page, a premise which entails one's conclusion. 

Such reasoning is, in one sense, circular and so may appear vicious: Why should I grant your first premise? the reader might ask. But in another sense it is not vicious. For any case intended to establish that *p* must take q or r as a hypothesis. If nothing is granted, nothing can be proved. 

The consequence of this reflection is that much depends upon one's choice of starting premises. 

My starting premise is this: **some of our empirical observations, and our rational reflection upon such observations, and our scientific conclusions derived upon such reflections and observations, are true.** 
